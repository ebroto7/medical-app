                ...
                {dayIndicator && isCurrentMonth && (
                  <div className="absolute bottom-1 left-1/2 -translate-x-1/2 flex gap-0.5">
                    {dayIndicator.meals > 0 && (
                      <div className="w-1.5 h-1.5 rounded-full bg-teal-500" title={`${dayIndicator.meals} comidas`}></div>
                    )}
                    {dayIndicator.trainings > 0 && (
                      <div className="w-1.5 h-1.5 rounded-full bg-amber-500" title={`${dayIndicator.trainings} entrenamientos`}></div>
                    )}
                  </div>
                )}
              </button>
